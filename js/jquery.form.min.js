  ...
  (e.fn.attr2 = function () {
    ...
    (e.fn.ajaxSubmit = function (a) {
      ...
      "function" == typeof a && (a = { success: a }),
        ...
        (s =
          (s =
            "string" == typeof (o = this.attr2("action")) ? e.trim(o) : "") ||
      ...
      var l = {};
      if ((this.trigger("form-pre-serialize", [this, a, l]), l.veto))
        return (
      ...
      if (
        (a.data && ((a.extraData = a.data), (f = e.param(a.data, c))),
        a.beforeSubmit && !1 === a.beforeSubmit(d, this, a))
      )
        return i("ajaxSubmit: submit aborted via beforeSubmit callback"), this;
      if ((this.trigger("form-submit-validate", [d, this, a, l]), l.veto))
        return (
          i("ajaxSubmit: submit vetoed via form-submit-validate trigger"), this
        );
      var p = e.param(d, c);
      f && (p = p ? p + "&" + f : f),
      ...
      a.success = function (e, t, r) {
        for (var n = a.context || this, i = 0, o = h.length; i < o; i++)
          h[i].apply(n, [e, t, r || u, u]);
      };
      ...
      var T,
        j = (g || b) && !y;
      !1 !== a.iframe && (a.iframe || j)
        ? a.closeKeepAlive
          ? e.get(a.closeKeepAlive, function () {
              T = S(d);
            })
          : (T = S(d))
        : (T =
      ...
      function S(t) {
        ...
        if (t)
          for (s = 0; s < m.length; s++)
            (o = e(m[s])),
              r ? o.prop("disabled", !1) : o.removeAttr("disabled");
        if (
          (((l = e.extend(!0, {}, e.ajaxSettings, a)).context = l.context || l),
          (f = "jqFormIO" + new Date().getTime()),
          l.iframeTarget
            ? (g = (d = e(l.iframeTarget)).attr2("name"))
              ? (f = g)
              : d.attr2("name", f)
            : (d = e(
                '<iframe name="' + f + '" src="' + l.iframeSrc + '" />'
          ...
          (h = {
            ...
            abort: function (t) {
              ...
              d.attr("src", l.iframeSrc),
                (h.error = r),
                l.error && l.error.call(l.context, h, r, t),
                c && e.event.trigger("ajaxError", [h, l, r]),
                l.complete && l.complete.call(l.context, h, r);
            },
          }),
          (c = l.global) && 0 == e.active++ && e.event.trigger("ajaxStart"),
          c && e.event.trigger("ajaxSend", [h, l]),
          l.beforeSend && !1 === l.beforeSend.call(l.context, h, l))
        )
          return l.global && e.active--, T.reject(), T;
        if (h.aborted) return T.reject(), T;
        (v = y.clk) &&
          (g = v.name) &&
          !v.disabled &&
          ((l.extraData = l.extraData || {}),
          (l.extraData[g] = v.value),
          "image" == v.type &&
            ((l.extraData[g + ".x"] = y.clk_x),
        ...
        function A() {
          ...
          y.setAttribute("target", f),
            ...
            r != l.url && y.setAttribute("action", l.url),
          ...
          try {
            if (l.extraData)
              for (var o in l.extraData)
                l.extraData.hasOwnProperty(o) &&
                  (e.isPlainObject(l.extraData[o]) &&
                  l.extraData[o].hasOwnProperty("name") &&
                  l.extraData[o].hasOwnProperty("value")
                    ? a.push(
                        e(
            ...
            y.setAttribute("action", r),
              t ? y.setAttribute("target", t) : u.removeAttr("target"),
              e(a).remove();
          }
        }
        D && k && ((l.extraData = l.extraData || {}), (l.extraData[D] = k)),
        ...
        function O(t) {
          if (!h.aborted && !M) {
            if (
              ((L = S(p)) || (i("cannot access response document"), (t = w)),
              t === j && h)
            )
              return h.abort("timeout"), void T.reject(h, "timeout");
            if (t == w && h)
              return (
                h.abort("server abort"),
                void T.reject(h, "error", "server abort")
              );
            if ((L && L.location.href != l.iframeSrc) || x) {
              p.detachEvent
                ? p.detachEvent("onload", O)
              ...
              try {
                ...
                (h.responseText = o ? o.innerHTML : null),
                  (h.responseXML = L.XMLDocument ? L.XMLDocument : L),
                  n && (l.dataType = "xml"),
                  (h.getResponseHeader = function (e) {
                    return { "content-type": l.dataType }[e];
                  }),
                  o &&
                    ((h.status = Number(o.getAttribute("status")) || h.status),
                    (h.statusText =
                      o.getAttribute("statusText") || h.statusText));
                var s = (l.dataType || "").toLowerCase(),
                  u = /(json|script|text)/.test(s);
                if (u || l.textarea) {
                  var f = L.getElementsByTagName("textarea")[0];
                  if (f)
                    (h.responseText = f.value),
                      (h.status = Number(f.getAttribute("status")) || h.status),
                      (h.statusText =
                        f.getAttribute("statusText") || h.statusText);
                  else if (u) {
                    var m = L.getElementsByTagName("pre")[0],
                      v = L.getElementsByTagName("body")[0];
                    m
                      ? (h.responseText = m.textContent
                          ? m.textContent
                          : m.innerText)
                      : v &&
                        (h.responseText = v.textContent
                          ? v.textContent
                          : v.innerText);
                  }
                } else
                  "xml" == s &&
                    !h.responseXML &&
                    h.responseText &&
                    (h.responseXML = X(h.responseText));
                try {
                  E = _(h, s, l);
                } catch (e) {
              ...
              h.aborted && (i("upload aborted"), (a = null)),
                h.status &&
                  (a =
                    (h.status >= 200 && h.status < 300) || 304 === h.status
                      ? "success"
                      : "error"),
                "success" === a
                  ? (l.success && l.success.call(l.context, E, "success", h),
                    T.resolve(h.responseText, "success", h),
                    c && e.event.trigger("ajaxSuccess", [h, l]))
                  : a &&
                    (void 0 === r && (r = h.statusText),
                    l.error && l.error.call(l.context, h, a, r),
                    T.reject(h, "error", r),
                    c && e.event.trigger("ajaxError", [h, l, r])),
                c && e.event.trigger("ajaxComplete", [h, l]),
                c && !--e.active && e.event.trigger("ajaxStop"),
                l.complete && l.complete.call(l.context, h, a),
                (M = !0),
    ...
    (e.fn.ajaxForm = function (t) {
      ...
      return t.delegation
        ? (e(document)
            ...
            .on("submit.form-plugin", this.selector, t, a)
            .on("click.form-plugin", this.selector, t, n),
          this)
        : this.ajaxFormUnbind()
            .bind("submit.form-plugin", t, a)
    ...
    (e.fn.formToArray = function (r, a) {
      ...
      for (i = 0, c = d.length; i < c; i++)
        if ((s = (l = d[i]).name) && !l.disabled)
          if (r && m.clk && "image" == l.type)
            m.clk == l &&
              (n.push({ name: s, value: e(l).val(), type: l.type }),
              n.push(
                { name: s + ".x", value: m.clk_x },
                { name: s + ".y", value: m.clk_y }
              ));
          else if ((u = e.fieldValue(l, !0)) && u.constructor == Array)
            for (a && a.push(l), o = 0, f = u.length; o < f; o++)
              n.push({ name: s, value: u[o] });
